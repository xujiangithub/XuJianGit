...
<html>
	<head>
		...
		<script type="text/javascript" src="/Probably/AppApp/Public/js/mymap.js" ></script>
		
		

</head>

<body style="font-family:'微软雅黑';font-size:25px;color:#ffff00;word-wrap:break-word;behavior:url('csshover.htc');">
<div id="alldiv" style="background:#19283f"></div> 
<div id="ditu" style="width:1210px;height:590px"></div>
    ...
    series : [
        ...
        },
        {
            ...
            markLine : {
                ...
                data : [
                    [{name:'绍兴'}, {name:'上海',value:95}],
                    [{name:'绍兴'}, {name:'广州',value:90}],
                    [{name:'绍兴'}, {name:'大连',value:80}],
                    [{name:'绍兴'}, {name:'南宁',value:70}],
                    [{name:'绍兴'}, {name:'南昌',value:60}],
                    [{name:'绍兴'}, {name:'拉萨',value:50}],
                    [{name:'绍兴'}, {name:'长春',value:40}],
                    [{name:'绍兴'}, {name:'包头',value:30}],
                    [{name:'绍兴'}, {name:'重庆',value:20}],
                    [{name:'绍兴'}, {name:'常州',value:10}]
                ]
            },
            markPoint : {
                symbol:'emptyCircle',
         ...
         success : function(result) {
             ...
             if (result) {
                    for(var i=0;i<result.length;i++){   
                       sum =  result[i].thisSaleTotal;
                    }
                    //myChart.hideLoading();    //隐藏加载动画
                    myChart_ditu.setOption({        //加载数据图表
						title : {
        text: '年累计交易额：￥' + sum,
        left: 'center',
        textStyle : {
