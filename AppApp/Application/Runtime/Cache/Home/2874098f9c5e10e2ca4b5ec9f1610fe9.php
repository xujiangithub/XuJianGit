...
<html>
	<head>
		<meta charset="UTF-8">
		<title></title>
		<link rel="stylesheet" href="/Probably/AppApp/Public/css/mysecond.css" />
		...
		<script type="text/javascript" src="/Probably/AppApp/Public/js/china.js" ></script>
       	...
       	<div class="row">
					...
					<table class="table">
							<thead>
								<tr style="height:70px">
									...
									<th>
										<?php echo ($data_dianzi[0]['number_electroni']); ?>个
									</th>
								</tr>
								<tr style="height:80px">
									...
									<th>
										<?php echo ($data_dianzi[0]['number_electricit']); ?>个
									</th>
								</tr>
								<tr style="height:80px">
									<th>
									...
									<th>
										<?php echo ($data_dianzi[0]['number_taobao']); ?>个
									</th>
								</tr>
								<tr style="height:80px">
									<th>
									...
									<th>
										<?php echo ($data_dianzi[0]['number_built']); ?>个
									</th>
								</tr>
							</thead>
					</table>
			...
			<div class="col-md-4" >
				<div class="col-md-12" style="margin-top:80px">
						<div id="main" class="col-md-12" style="margin-top:80px"><img style="width:650px;height:650px;" src="/Probably/AppApp/Public/img/诸暨2.png"/></div>
			...
			<div class="col-md-4">
				<div class="col-md-12" style="border-right:#ffffff dashed 1px;border-left:#ffffff dashed 1px;border-top:#ffffff dashed 1px;border-bottom:#ffffff dashed 1px">
					...
					<table class="table"  style="font-size:18px;">
						...
						<tbody>		
						<?php if($data_cuntao[0]['id'] == ''): ?><tr><td>暂无数据</td></tr>
                        <?php else: ?>
                        <?php if(is_array($data_cuntao)): foreach($data_cuntao as $key=>$v): ?><tr class="mybg">
                                <td>No.<?php echo ($v["ranking"]); ?></td>
                                <td><?php echo ($v["upstream_number"]); ?>号</td>
                                <td><?php echo ($v["site_top"]); ?>万</td>
								<td><?php echo ($v["site_down"]); ?>万</td>
                                <td><?php echo ($v["downstream_number"]); ?>号</td>
				...
				<div class="col-md-12" style="border-right:#ffffff dashed 1px;border-left:#ffffff dashed 1px;border-top:#ffffff dashed 1px;border-bottom:#ffffff dashed 1px">
					...
					<table class="table" style="font-size:18px;">
						...
						<tbody>		
						<?php if($data_dianxiao[0]['id'] == ''): ?><tr><td>暂无数据</td></tr>
                        <?php else: ?>
                        <?php if(is_array($data_dianxiao)): foreach($data_dianxiao as $key=>$v): ?><tr class="mybg">
                                <td>No.<?php echo ($v["ranking"]); ?></td>
